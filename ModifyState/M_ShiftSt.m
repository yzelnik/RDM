...
% Shift a given state by Es.ShiftParms
% Es.ShiftParms can be given in relative (0..1) terms, or in Nx/Ny terms
...
if((Ps.Nx==1) || (Ps.Ny==1))
    ...
    shiftx=Es.ShiftParms(1);
    shifty=Es.ShiftParms(2);
    ...
    %VsOut = cat(1,Vs(Es.ShiftParms(1):end,:,:),Vs(1:Es.ShiftParms(1)-1,:,:));
