...
% Ps=struct('LocFunc',@L_GR,'SpaFunc',@S_RD,'IntegFunc',@I_PSRD,'P',80,'eta',6,'kappa',1,'mu',2,'nu',4,'lambda',0.06,'gamma',4.,'rho',0.2,'Ds',[0.02 20],'Vnum',2,'Lx',50,'Ly',1,'Nx',500,'Ny',1);
% Es=struct('Tstep',0.1,'Tdest',200,'Jcob',0,'posflag',1,'LSAthresh',0,'InitByODE',1,'STsmall',0.001,'SSthresh',1e-5,'St1Color',circshift(hsv(6),-2)*0.66,'BfColor',[0 0 0 ; 1 0 0; 0 0.75 0; 0 0 1; 0 0.75 0.75; 1 0 1],'BfStyle',['-- ';'-  ';'x  ']);
